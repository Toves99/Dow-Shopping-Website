...
<div class="container">
<p style="position:absolute;margin-top:-20px;margin-left:30px;font-size:16px;color:black;"><a href="index.php" style="color:grey;">Food /</a>Cereals</p>
<section style="margin-top:70px;background-color:lightgrey;height:270vh;" id="pro">
      <div class="container5">
       <?php
       $select_products = mysqli_query($conn, "SELECT * FROM `soyabeans`");
