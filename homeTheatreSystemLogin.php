...
<section style="margin-top:70px;background-color:lightgrey;height:auto;" id="pro">
      <div class="container5">
       <?php
       $select_products = mysqli_query($conn, "SELECT * FROM `hometheatre`");
     ...
     <form action="" method="post">
      <img src="images/<?php echo $fetch_product['image']; ?>" alt="" style="width:150px;margin-left:70px;height:130px">
