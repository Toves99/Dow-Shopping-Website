...
<div class="container">
  <p style="position:absolute;margin-top:-20px;margin-left:30px;font-size:16px;color:black;"><a href="indexLogin.php" style="color:grey;">Electronics/</a>ElectronicsCamera</p>
<section style="margin-top:70px;background-color:lightgrey;height:auto;" id="pro">
<div class="container5">
       <?php
       $select_products = mysqli_query($conn, "SELECT name,price,image FROM cctv,electroniccameras WHERE cctv.productId=electroniccameras.productId");
     ...
     <img src="images/<?php echo $fetch_product['image']; ?>" alt="" style="width:100px;margin-left:70px;height:100px;height:130px;">
      <h3 style="margin-left:20px;width:220px;font-size:12px;margin-top:-2px;position:absolute;font-family:Helvetica;color:grey;"><?php echo $fetch_product['name']; ?></h3>
