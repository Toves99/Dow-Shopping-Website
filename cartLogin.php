...
<div class="container">
   <section class="shopping-cart">
      <table>
         ...
         <tbody>
            ...
            <tr class="table-bottom">
               <td><a href="indexLogin.php#pro" class="option-btn" style="margin-top: 0;">continue shopping</a></td>
      ...
      <div class="checkout-btn">
         <a href="checkoutlogin.php" class="btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>">proceed to checkout</a>
      </div>
   </section>
</div>
