...
if(isset($_POST['submit'])){
   $lastInsertId = $_SESSION['Id'];
   print_r("id is".$lastInsertId);
    ...
    elseif(!$uppercase || !$lowercase || !$number || strlen($password) < 8){
      ...
      $message = "<div class='alert alert-danger'>Passwords must contain An uppercase,Lowercase,A special character a number and it must be equal or greater than 8</div>";
        ...
        $insert_query="insert into `user` (Id,userEmail,userLocation,password) values ('$lastInsertId','$userEmail','$userLocation','$password_hash')";
        ...
        <div class="panels-container">
            ...
            <div class="panel right-panel">
                <div class="content">
                    ...
                    <a href="loginsupermarket.php" class="btn transparent" id="sign-in-btn" style="padding:10px 20px;text-decoration:none;
